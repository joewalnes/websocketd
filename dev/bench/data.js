    ...
    "websocketd Performance": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": false,
          "id": "1393cbf5e95c341a60af1e0e473ecdc9d06de308",
          "message": "Stop the static file server following symlinks out of --staticdir\n\nhttp.FileServer(http.Dir(StaticDir)) blocks \"..\" traversal but still\nfollows a symlink placed inside StaticDir that points outside it, serving\nthe target's contents — read-only disclosure of arbitrary files. It needs a\nsymlink to already exist inside the served directory, so this is lower\nseverity than the CGI escape, but the server should still hold the boundary.\n\nWrap the filesystem in a boundedDir that defers to http.Dir for cleaning,\n\"..\" rejection, and os error semantics (missing files stay 404), then reuses\ncheckPathBoundary on the resolved path and returns os.ErrNotExist if it\nescapes. Wrapping the FileSystem rather than pre-checking in serveStatic\nguards every Open the FileServer performs (index.html, directory entries),\nnot just the top-level request path. Symlinks that stay within the directory\nstill resolve.\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>",
          "timestamp": "2026-08-17T11:21:07-07:00",
          "tree_id": "90b15ffbae8ba65ad08b10e1fd80652aa239b9bc",
          "url": "https://github.com/joewalnes/websocketd/commit/1393cbf5e95c341a60af1e0e473ecdc9d06de308"
        },
        "date": 1786991507123,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "53c73db387748851b33e437aac9e0b60ee907bdb",
          "message": "Fix the Windows CGI path test, which asserted the wrong outcome\n\nTestResolveCgiPathBackslash has been red on Windows CI since the --cgidir\nconfinement landed. It looked like a traversal gap but was not: the paths it\nflagged were C:\\srv\\cgi\\windows\\system32\\cmd.exe and C:\\srv\\cgi\\evil.bat,\nboth inside the CGI directory.\n\nfilepath.ToSlash rewrites every backslash to a slash before path.Clean runs,\nso a \"..\\\" segment folds back inside cgiDir exactly like \"../\" does — which\nis the behavior the slash cases in the sibling table deliberately accept. The\ntest demanded refusal for one spelling and fold-back for the other.\n\nAssert the property that actually matters instead: the resolved path is\ncontained in cgiDir, checked with containsPath on every accepted result\nindependently of the expected string. Adds a nested backslash path and two\ncases that must still be refused because they reduce to the directory itself.\n\nAlso corrects the comment in resolveCgiPath (and the matching diary entry)\nthat credited the containsPath call with catching Windows separators that\nslash-space cleaning never saw. That mechanism does not exist; the check is\nkept as a fail-closed guard and is now commented as such.\n\nNo behavior change and no security impact.\n\nCo-Authored-By: Claude Opus 5 (1M context) <noreply@anthropic.com>",
          "timestamp": "2026-08-17T11:39:49-07:00",
          "tree_id": "58ced5f0115904ba05e83da5e2640e05c2123b8b",
          "url": "https://github.com/joewalnes/websocketd/commit/53c73db387748851b33e437aac9e0b60ee907bdb"
        },
        "date": 1786992219023,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "5b01d24a739908aaa964e17e2e27efb070e5a5f9",
          "message": "Stop one failing platform cancelling the rest of the test matrix\n\nThe default fail-fast cancelled the Windows job 57s in because the ARM64 job\nhad failed on an unrelated flake, so the run reported nothing about the\nplatform whose result was actually being waited on. A cross-platform matrix\nis least informative exactly when it stops at the first red runner.\n\nCo-Authored-By: Claude Opus 5 (1M context) <noreply@anthropic.com>",
          "timestamp": "2026-08-17T11:57:36-07:00",
          "tree_id": "7d1b77d8551e262dc7ea260c752dbcc6b26fc523",
          "url": "https://github.com/joewalnes/websocketd/commit/5b01d24a739908aaa964e17e2e27efb070e5a5f9"
        },
        "date": 1786993281454,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "a4e07977e08d83f4bffe83982717a314939f810d",
          "message": "Serve the website from website/ on main via GitHub Actions\n\nThe site lived on the gh-pages branch, which is the legacy Pages layout and\nmeant the website was invisible during normal work — a change to the CLI or\nthe tutorial had to be remembered separately, on another branch, and usually\nwas not.\n\nMove the site to website/ on main and publish it with actions/deploy-pages.\nDeploying from a workflow rather than a branch also leaves room for a build\nstep later, which is what makes a generated manual (#467) practical without\ncommitting built HTML.\n\nwebsite/CNAME carries the custom domain and is part of the deployed artifact.\nPages reads the custom domain from the published site, so a deploy without it\ncan clear the domain and the TLS cert with it; the workflow fails fast if the\nfile is missing rather than publishing a site that silently drops it.\n\nThe gh-pages branch is kept, because bench.yml still pushes benchmark results\nthere, but it is no longer served. https://websocketd.com/dev/bench/ will\nstart returning 404 — the data remains on the branch and the benchmark\ntooling is untouched.\n\nCo-Authored-By: Claude Opus 5 <noreply@anthropic.com>",
          "timestamp": "2026-08-20T06:14:07-07:00",
          "tree_id": "90f3111e36189d35f811a519356edc0e81211f5d",
          "url": "https://github.com/joewalnes/websocketd/commit/a4e07977e08d83f4bffe83982717a314939f810d"
        },
        "date": 1787231869313,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "1c4c5185ded4605ceb7913c4c505f1c05eaf5242",
          "message": "Point site links at https and drop the dead benchmark dashboard link\n\nwebsocketd.com now enforces HTTPS, so the http:// links in --help, the dev\nconsole, the man page and the fpm package metadata only served a redirect.\n\nbench/README.md linked to https://websocketd.com/dev/bench/, which stopped\nresolving when the site moved off the gh-pages branch. The benchmark action\nstill publishes there and the data is intact, so point at the branch instead\nof a URL that 404s.\n\nCo-Authored-By: Claude Opus 5 <noreply@anthropic.com>",
          "timestamp": "2026-08-20T07:52:33-07:00",
          "tree_id": "ba8f28db0251e86b04f37fe9e84616592576c30e",
          "url": "https://github.com/joewalnes/websocketd/commit/1c4c5185ded4605ceb7913c4c505f1c05eaf5242"
        },
        "date": 1787237779494,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "fa6373a1be4001dce6ce8eb50b9c0e456384d29e",
          "message": "Drop FreeBSD, OpenBSD and Solaris release targets\n\nNobody used the published binaries for these, and the download links on the\nhomepage still pointed at v0.3.0. Releases now cover Linux (amd64/386/arm/\narm64), macOS (amd64) and Windows (amd64/386).\n\nThis is about shipped artifacts only. The source still compiles for all three\nwith a plain `go build`, verified, and their defaultPassEnv entries in\nconfig.go are left alone so building from source on those systems keeps the\nright CGI environment defaults.\n\nRemoved alongside: the BSD/Solaris download block and its inline FreeBSD and\nSolaris logos from the homepage, the OpenBSD logo asset, and the matching QA\nplan cases (BUILD-018/019/020, the FreeBSD/OpenBSD/Solaris sections of\n08-platform-unix.md, and the coverage lists in qa/plans/README.md).\n\nTwo dead things in release/Makefile went with them: UNAME_SYS and UNAME_ARCH\nwere computed but never referenced by any rule, and FLAGS_darwin_386 had no\nentry in PLATFORMS.\n\nAlso deletes six unused PNGs under website/icons/. Each icon is referenced as\nan SVG; the PNG siblings were unreferenced. The Noun Project license.txt files\nstay with their icons.\n\nCo-Authored-By: Claude Opus 5 <noreply@anthropic.com>",
          "timestamp": "2026-08-20T07:57:53-07:00",
          "tree_id": "9a4599e00539da99a8e39b74395b63fb020d8bbb",
          "url": "https://github.com/joewalnes/websocketd/commit/fa6373a1be4001dce6ce8eb50b9c0e456384d29e"
        },
        "date": 1787238097721,
        "tool": "customSmallerIsBetter",
        "benches": [
