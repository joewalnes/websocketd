...
func getHelpMessage(content string) string {
  msg := strings.TrimSpace(content)
  msg = strings.Replace(msg, "{{binary}}", processName(), -1)
  return strings.Replace(msg, "{{version}}", getVersionString(), -1)
}
